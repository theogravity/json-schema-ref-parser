...
$Ref.dereference = function ($ref, resolvedValue) {
  if (resolvedValue && typeof resolvedValue === "object" && $Ref.isExtended$Ref($ref)) {
    ...
    if (!merged["x-original-ref"]) {
      merged["x-original-ref"] = [$ref.$ref];
    }
    else {
      merged["x-original-ref"].push($ref.$ref);
      merged["x-original-ref"] = removeDuplicates(merged["x-original-ref"]);
    }
    ...
    if (typeof resolvedValue === "object") {
      if (!resolvedValue["x-original-ref"]) {
        resolvedValue["x-original-ref"] = [$ref.$ref];
      }
      else {
        resolvedValue["x-original-ref"].push($ref.$ref);

        resolvedValue["x-original-ref"] = removeDuplicates(resolvedValue["x-original-ref"]);
      }
    }
